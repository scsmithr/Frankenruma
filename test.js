...
var ASM_CONSTS = [function() { throw "callback not a function" },
 function() { throw "error scanning" },
 function() { throw 'unable to build regexp' }];
...
STATICTOP = STATIC_BASE + 278560;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_base_scanner_cc() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } });
...
var real___GLOBAL__sub_I_base_scanner_cc = asm["__GLOBAL__sub_I_base_scanner_cc"]; asm["__GLOBAL__sub_I_base_scanner_cc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_base_scanner_cc.apply(null, arguments);
};
Module["asm"] = asm;
...
var __GLOBAL__sub_I_base_scanner_cc = Module["__GLOBAL__sub_I_base_scanner_cc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_base_scanner_cc"].apply(null, arguments) };
